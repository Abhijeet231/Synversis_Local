import {Building, Contact, Mail, Phone, Globe, Edit, UserX} from "lucide-react"
    ...
    <div className="mt-5 p-5">
        ...
        <div className="flex items-start  gap-3 mt-5">
              ...
              <div className=" flex-col p-2 ml-5  ">
                <span className="text-green-600 bg-green-100 rounded-lg px-3 py-0.5 border mr-3 text-xs align-top">Active</span>
                <span className="text-purple-700  rounded-lg border bg-purple-100 px-3 py-0.5 text-xs align-top">Premium</span>
